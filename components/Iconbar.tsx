    ...
    <>
      <nav>
        <ul className="flex justify-center space-x-10">
          <div className="flex-col justify-items-center text-center hover:bg-blue-200 hover:cursor-pointer p-5 rounded-3xl transform scale-100 hover:scale-[1.1] transition duration-200">
            <Image
              src="/house-solid.svg"
              alt="house"
              width={102}
